...
@section("content")
    <div class="card shadow mb-4">
        <div class="card-body">
            <div class="bgc-white p-20 bd"><h3 class="c-grey-900">Edit Role</h3>
                <div class="mT-30">
                    <form action="{{ route("role.update", ["id" => $data->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label class="common-label" for="role_name">Role Name</label>
                                <input type="text" class="form-control" value="{{ old("role_name", $data->role_name) }}"
