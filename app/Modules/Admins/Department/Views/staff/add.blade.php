...
@section("content")
    <div class="card shadow mb-4">
        <div class="card-body">
            <div class="bgc-white p-20 bd"><h3 class="c-grey-900">Add Student</h3>
                <div class="mT-30">
                    <form action="{{ route("staff.create") }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" value="{{ old("staff_name") }}"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select id="department" class="form-control" name="department">
                                    ...
                                    @foreach($departments as $item)
                                        <option value="{{ $item->id }}" @if(old("department") == $item->id) selected="selected" @endif>{{ $item->department_name }}</option>
                                    @endforeach
                                </select>
                                @error('department')
                                <span class="text-danger">{{ $message }}</span>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label class="common-label" for="staff_name">Password</label>
