    ...
    <div class="main-body p-0">
        <div class="inner-wrapper">
                        ...
                        <div class="simplebar-wrapper" style="margin: -16px;">
                            ...
                            <div class="simplebar-mask">
                                ...
                                <div class="simplebar-content" style="padding: 16px; width: 100%;">
                                    <a href="{{ route("my-idea") }}" class="my-idea {{ Request::is("my-idea") ? "active" : "" }}" style="padding: 10px 50px">My Idea</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="inner-main">
                <!-- Inner main header -->
                <form id="formSearch" action="{{ route("my-idea") }}">
                            ...
                            <div class="card-body p-2 p-sm-3">
                                <div class="media forum-item">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="text-muted">replied <span class="text-secondary font-weight-bold">13 minutes ago</span>
                                        </p>
                                    </div>
