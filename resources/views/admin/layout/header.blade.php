<div class="header navbar">
    <div class="header-container">
        ...
        <ul class="nav-right">
            ...
            <li class="notifications dropdown"><span class="counter bgc-blue">3</span>
            ...
            <li class="dropdown">
                   ...
                   data-toggle="dropdown">
                    <div class="peer mR-10">
                        <img class="w-2r bdrs-50p"
                             src="{{ empty($user->avatar) ? asset("asset/images/icon_member.png") :  asset("save_image/". $user->avatar) }}"
                             alt=""></div>
                    <div class="peer"><span class="fsz-sm c-grey-900">{{ $user->full_name }}</span></div>
                </a>
                <ul class="dropdown-menu fsz-sm">
                    ...
                    <li>
                        <a href="{{route("admin.logout")}}" onclick="document.getElementById('logout-frm').submit();"
